...
beforeAll(() => {
    mockedGot.mockReturnValue(partiallyMock<CancelableRequest>({ json: mockResponse }));
});
...
test('convertPostcodeToGps - should give error for not real postcode', async () => {
    ...
    await expect(async () => await convertPostcodeToGps('sw11zz')).rejects.toThrowError('Unable');
});
...
test('getWeatherFromStation - should get obs for nearest site to edinburgh', async () => {
    ...
    mockedGot.mockReturnValueOnce(partiallyMock<CancelableRequest>({ json: mockedSites }));
    mockedGot.mockReturnValueOnce(partiallyMock<CancelableRequest>({ json: mockedObservations }));
...
test('getWeatherFromStation - should get obs for unknown visibility', async () => {
    const mockedSites = jest.fn().mockResolvedValue(weatherSites);
    const mockedObservations = jest.fn().mockResolvedValue(weatherObsUnknownVisibility);
    mockedGot.mockReturnValueOnce(partiallyMock<CancelableRequest>({ json: mockedSites }));
    mockedGot.mockReturnValueOnce(partiallyMock<CancelableRequest>({ json: mockedObservations }));
...
test('getWeatherFromStation - should get obs for very poor visibility', async () => {
    const mockedSites = jest.fn().mockResolvedValue(weatherSites);
    const mockedObservations = jest.fn().mockResolvedValue(weatherObsVeryPoorVisibility);
    mockedGot.mockReturnValueOnce(partiallyMock<CancelableRequest>({ json: mockedSites }));
    mockedGot.mockReturnValueOnce(partiallyMock<CancelableRequest>({ json: mockedObservations }));
...
test('getWeatherFromStation - should get obs for poor visibility', async () => {
    const mockedSites = jest.fn().mockResolvedValue(weatherSites);
    const mockedObservations = jest.fn().mockResolvedValue(weatherObsPoorVisibility);
    mockedGot.mockReturnValueOnce(partiallyMock<CancelableRequest>({ json: mockedSites }));
    mockedGot.mockReturnValueOnce(partiallyMock<CancelableRequest>({ json: mockedObservations }));
...
test('getWeatherFromStation - should get obs for moderate visibility', async () => {
    const mockedSites = jest.fn().mockResolvedValue(weatherSites);
    const mockedObservations = jest.fn().mockResolvedValue(weatherObsModerateVisibility);
    mockedGot.mockReturnValueOnce(partiallyMock<CancelableRequest>({ json: mockedSites }));
    mockedGot.mockReturnValueOnce(partiallyMock<CancelableRequest>({ json: mockedObservations }));
...
test('getWeatherFromStation - should get obs for good visibility', async () => {
    const mockedSites = jest.fn().mockResolvedValue(weatherSites);
    const mockedObservations = jest.fn().mockResolvedValue(weatherObsGoodVisibility);
    mockedGot.mockReturnValueOnce(partiallyMock<CancelableRequest>({ json: mockedSites }));
    mockedGot.mockReturnValueOnce(partiallyMock<CancelableRequest>({ json: mockedObservations }));
...
test('getWeatherFromStation - should get obs for very good visibility', async () => {
    const mockedSites = jest.fn().mockResolvedValue(weatherSites);
    const mockedObservations = jest.fn().mockResolvedValue(weatherObsVeryGoodVisibility);
    mockedGot.mockReturnValueOnce(partiallyMock<CancelableRequest>({ json: mockedSites }));
    mockedGot.mockReturnValueOnce(partiallyMock<CancelableRequest>({ json: mockedObservations }));
...
test('getWeatherFromStation - should get obs for excellent visibility', async () => {
    const mockedSites = jest.fn().mockResolvedValue(weatherSites);
    const mockedObservations = jest.fn().mockResolvedValue(weatherObsExcellentVisibility);
    mockedGot.mockReturnValueOnce(partiallyMock<CancelableRequest>({ json: mockedSites }));
    mockedGot.mockReturnValueOnce(partiallyMock<CancelableRequest>({ json: mockedObservations }));
